                ...
                <div className="container mx-auto px-4 py-12 sm:py-24 lg:py-32 pb-[calc(env(safe-area-inset-bottom)+48px)] relative z-10 flex-1 flex flex-col">
                    <div className="mx-auto max-w-4xl text-center flex-1 flex flex-col justify-center">
                        ...
                        >
                            <h1
                                id="main-title"
                                className="text-3xl font-bold tracking-tight text-foreground sm:text-5xl lg:text-7xl"
                            >
                                Build the{" "}
                        ...
                        >
                            DevSphere is the Open Source and Web 3.0 club of RV
                            University. Join us to learn, build, and contribute
                            to cutting-edge technologies that are shaping the
